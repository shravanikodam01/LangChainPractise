...
textToSplit = f"""One of the most important things I didn't understand about the world when I was a child is the degree to which the returns for performance are superlinear.
...
result = splitter.split_text(textToSplit)

# We have one more function split_documents which takes in a list of documents and splits them. It is more efficient than split_text when we have multiple documents to split.
